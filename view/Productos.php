    ...
    <section id="principal">
        <article id="contenidoIngresoAsociado">
            <div class="boxed" id="menuIngresoAsociado"><br/>
                <span><a href="indexPrincipal.php?altaBaja"><div>Dar alta o baja a un cliente</div></a></span><br/>
                <span><a href="?buscarAsociado"><div>Buscar cliente</div></a></span><br/>
                <span><a href="?buscarAsociado"><div>Eliminar cliente</div></a></span>
            </div>
            <div class="boxed" id="divContenedorIngreso">
                <br/><br/><br/>
                <form action="?Clientes=ingresar" method="post">
